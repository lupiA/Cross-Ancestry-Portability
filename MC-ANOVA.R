MC_ANOVA2B <- function(X, X2 = NULL, core, nQTL, nRep = NULL, maxRep = 300, lambda = 1e-8, sampler = rnorm, ...) {
    ...
    # This function is a faster version of MC_ANOVA2.
    # See MC_ANOVA for a function where core SNPs that are not QTL are not used for prediction.
    # See MC_ANOVA2 for a slower version of this function.
